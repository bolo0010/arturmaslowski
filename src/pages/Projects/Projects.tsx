                            ...
                            <div className="rounded-lg text-center">
                                {
                                    loading ? (
                                            <div className="min-h-[25vh] flex justify-center items-center">
                                                <div
                                                    className="inline-block h-12 w-12 animate-spin rounded-full border-4 border-solid border-current border-r-transparent align-[-0.125em] text-blue-800 motion-reduce:animate-[spin_1.5s_linear_infinite] text-center"
                                                    role="status">
                                                <span
